...
urlpatterns = [
    ...
    url(r'^(?P<surveyee_caseNum>[0-9]+)/(?P<survey>[0-9]+)/peb/start/$',questions_view.EB_view, name='peb_start'),
    url(r'^(?P<surveyee_caseNum>[0-9]+)/(?P<survey>[0-9]+)/peb/(?P<virsion>[0-9]+)$', survey_views.EB_view1, name = "peb"),
